 ...
 <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
   ...
   <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
     <div class="container">
       <a class="navbar-brand" href="index.html"><span class="fas fa-laptop"></span>Community Hub</a>
   ...
   <section class="hero-wrap hero-wrap-2" style="background-image: url('img/login2.jpg');" data-stellar-background-ratio="0.5">
     <div class="overlay"></div>
     <div class="container">
       <div class="row no-gutters slider-text align-items-end justify-content-center">
         <div class="col-md-9 ftco-animate pb-5 text-center">
           <h1 class="mb-3 bread">Our <span>Blog</span></h1>
         </div>
       </div>
     </div>
   </section>
           ...
           <div class="sidebar-box ftco-animate">
             ...
             <div class="block-21 mb-4 d-flex">
               ...
               <div class="text">
                 ...
                 <div class="meta">
                   <div><a href="#"><span class="fa fa-calendar"></span> April 04, 2019</a></div>
                   <div><a href="#"><span class="fab fa-person"></span> Admin</a></div>
                   <div><a href="#"><span class="fas fa-chat"></span> 19</a></div>
                 </div>
               </div>
             </div>
             <div class="block-21 mb-4 d-flex">
               ...
               <div class="text">
                 ...
                 <div class="meta">
                   <div><a href="#"><span class="fa fa-calendar"></span> April 04, 2019</a></div>
                   <div><a href="#"><span class="fa fa-person"></span> Admin</a></div>
                   <div><a href="#"><span class="fa fa-chat"></span> 19</a></div>
                 </div>
               </div>
             </div>
             <div class="block-21 mb-4 d-flex">
       ...
       <div class="row mb-5">
         <div class="col-md">
           <div class="ftco-footer-widget mb-4">
             <h2 class="ftco-heading-2 logo"><span>Community</span> Hub</h2>
         ...
         <div class="col-md">
           <div class="ftco-footer-widget mb-4 ml-md-5">
             ...
             <ul class="list-unstyled">
               <li><a href="#" class="py-1 d-block"><span class="fab fa-arrow-forward mr-3"></span>Staff</a></li>
